...
let data = [
    ...
    },
    {
        ...
        disc : "e-Ops is web portal is developed in React.js and backend in DotNet with SQL Server. This portal is used by field operations staff in all 10 Discos customer support centers to process consumers’ requests: new connection, change of attributes, bill correction, meter reading correction, complaints, meter change request, opt for smart meter etc"
    },
    {
